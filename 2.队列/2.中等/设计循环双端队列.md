...
MyCircularDeque.prototype.insertFront = function(value) {
    ...
    if (this.isEmpty()) {
        ...
        this.higtCount++;
        for (let i = this.higtCount; i > 0; i--) {
...
MyCircularDeque.prototype.insertLast = function(value) {
    if (this.isFull()) return false;
    this.items[this.higtCount] = value;
    this.higtCount++;
    return true;
};
...
MyCircularDeque.prototype.deleteLast = function() {
    if (this.isEmpty()) return false;
    delete this.items[this.higtCount];
    this.higtCount--;
    return true;
};
...
MyCircularDeque.prototype.getRear = function() {
    if (this.isEmpty()) return -1;
    return this.items[this.higtCount - 1];
};

MyCircularDeque.prototype.isEmpty = function() {
    return this.higtCount - this.lowestCount === 0;
};

MyCircularDeque.prototype.isFull = function() {
    return this.higtCount - this.lowestCount >= this.capacity;
};
```
...
class MyCircularDeque {
    ...
    getRear(): number {
        if (this.isEmpty()) return -1;
        return this.queue[this.endIndex - 1];
    }

    isEmpty(): boolean {
        return this.endIndex - this.headIndex === 0;
    }

    isFull(): boolean {
        return this.endIndex - this.headIndex >= this.k;
    }
}
```